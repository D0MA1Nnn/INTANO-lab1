...
<h2 class="process" >Process Payment (Booking #<?php echo $booking_id; ?>)</h2>

<p class="process" >Total Cost: ₱<?php echo number_format($booking['total_cost'],2); ?></p>
<p class="process">Total Paid: ₱<?php echo number_format($total_paid,2); ?></p>
<p class="process"><b>Balance: ₱<?php echo number_format($balance,2); ?></b></p>
...
<form method="post">
    ...
    <button class="action_link" type="submit" name="pay">Save Payment</button>
</form>
